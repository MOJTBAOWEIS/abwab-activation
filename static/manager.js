/* لوحة المدير — أربعة تبويبات، كل الأرقام تُحسب من الفلاتر في الأعلى. */
...
(function () {
  ...
  function paintTeam() {
    ...
    $("tab-team").innerHTML =
      ...
      + section("الفروع",
        ...
        + "<strong>قيمة الموقع</strong> = هل يستحق هذا الفرع الاستمرار.",
  ...
  function boot() {
    ...
    // بدون ما يضطر المدير يعمل تحديث للصفحة.
